...
const rawProductos = [
  {
    ...
    img2: 'images/productos/cerramientos/2.png',
    img3: 'images/productos/cerramientos/3.png',
    img4: 'images/productos/cerramientos/4.png',
    img5: 'images/productos/cerramientos/4.png',
    img6: 'images/productos/cerramientos/4.png',
    modelos: {
      "modelo-1": {
        nombre: "Modelo Alux",
      ...
      "modelo-2": {
        ...
        nombre2: "Modelo<br />Espiga",
        imagenes: {
          img1: 'images/productos/cerramientos/espiga/1.png',
  ...
  },
  {
    ...
    img2: 'images/productos/barandas/2.jpg',
    img3: 'images/productos/barandas/3.jpeg',
    img4: 'images/productos/barandas/4.jpeg',
    img5: 'images/productos/barandas/5.jpg',
    img6: 'images/productos/barandas/6.jpg',
    modelos: {
      "modelo-1": {
        nombre: "Modelo Berlín",
        nombre2: "Modelo<br />Berlín",
        imagenes: {
        ...
        descripcion: "Este modelo está íntegramente realizado en acero inoxidable 304, pulido esmerilado.<br/>Pueden optar entre dos presentaciones: Una con columnas de caño redondo de 50 mm, con roseta y embellecedor, y pasamanos redondo. La segunda opción es de columnas de caño cuadradas de 40 mm, con roseta y embellecedor, y pasamanos rectangular. En ambos casos se utilizan 4 barras o caños de contención de 13 mm."
      },
      "modelo-2": {
        nombre: "Modelo Vienna",
        nombre2: "Modelo<br />Vienna",
        imagenes: {
          img1: 'images/productos/barandas/vienna/1.jpg',
          img2: 'images/productos/barandas/vienna/2.jpg',
          img3: 'images/productos/barandas/vienna/3.jpg',
          img4: 'images/productos/barandas/vienna/4.jpg',
          img5: 'images/productos/barandas/vienna/5.jpg',
          img6: 'images/productos/barandas/vienna/6.jpg',
          img7: 'images/productos/barandas/vienna/7.jpg',
          img8: 'images/productos/barandas/vienna/8.jpg',
          img9: 'images/productos/barandas/vienna/9.png',
          img10: 'images/productos/barandas/vienna/10.jpg',
        },

        descripcion: "Este modelo combina una estructura de acero inoxidable 304 con vidrio templado de 10mm. Pueden optar entre dos presentaciones: Una con columnas de caño redondo de 50 mm, con roseta y embellecedor, y pasamanos redondo. La segunda opción es de columnas de caño cuadradas de 40 mm, con roseta y embellecedor, y pasamanos rectangular. En ambos casos se utiliza vidrio templado, en la zona de contención, sujeto por clips de acero inoxidable a las columnas de la escalera."
      },
      "modelo-3": {
        nombre: "Modelo Florencia",
        nombre2: "Modelo<br />Florencia",
        imagenes: {
          img1: 'images/productos/barandas/florencia/1.jpeg',
          img2: 'images/productos/barandas/florencia/2.jpeg',
          img3: 'images/productos/barandas/florencia/3.jpeg',
          img4: 'images/productos/barandas/florencia/4.jpeg',
          img5: 'images/productos/barandas/florencia/5.jpeg',
          img6: 'images/productos/barandas/florencia/6.jpeg',
          img7: 'images/productos/barandas/florencia/7.jpeg',
          img8: 'images/productos/barandas/florencia/8.jpeg',
        },
        descripcion: "Este modelo está íntegramente realizado en vidrio templado de 10 mm que se fija a la escalera mediante sujetadores redondos de acero inoxidable. Opcional: pasamano sobre el vidrio."
      }
    }
  },
  {
    ...
    titulo: 'Pasamanos para interiores y exteriores',
    subtitulo: "Ideales para escaleras internas, entradas a edificios y accesos de todo tipo.",
    descripcion: 'Diseñados en caño de acero inoxidable 304, pulido esmerilado, de 38 mm y 50 mm de diámetro.<br/>Ideales para escaleras internas, entradas a edificios y accesos de todo tipo.<br/>Están fijados con soportes y tornillería de acero inoxidable lo que brinda una calidad, estilo y durabilidad inmejorables para un producto que lo acompañará de por vida.',
    slug: 'pasamanos-para-interiores-y-exteriores',
  ...
  },
  {
    ...
    subtitulo: "Realizados en acero inoxidable 304 pulido esmerilado de 1mm, se integran perfecto al piso del espacio que elijas.",
  ...
  {
    id: 5,
    imagen: 'images/productos/5.png',
    titulo: 'Revestimiento de acero inoxidable',
    subtitulo: "Revestimientos íntegramente confeccionados en chapa de acero inoxidable 430 y 304.",
    descripcion: 'Revestimientos íntegramente confeccionados en chapa de acero inoxidable 430 y 304.<br/>La opción ideal para cocinas, gastronomía y restaurantes ya que le permitirá crear un estilo único y distintivo con un producto de alta calidad, resistente, duradero y muy fácil de limpiar.<br/>Contamos con distintos acabados que ofrecen la posibilidad de darle un toque único a su espacio.',
    slug: 'revestimiento-de-acero-inoxidable',
    img1: 'images/productos/revestimientos/1.jpg',
    img2: 'images/productos/revestimientos/2.png',
    img3: 'images/productos/revestimientos/3.jpg',
    img4: 'images/productos/revestimientos/4.jpg',
    ...
    modelos: {
      "modelo-1": {
        ...
        nombre2: "Diseño 100%<br />adaptado a tus<br />espacios",
        imagenes: {
          img1: 'images/productos/revestimientos/7.jpg',
          img2: 'images/productos/revestimientos/8.png',
          img3: 'images/productos/revestimientos/9.jpeg',
          img4: 'images/productos/revestimientos/10.jpg',
          img5: 'images/productos/revestimientos/11.jpg',
          img6: 'images/productos/revestimientos/12.png',
          img7: 'images/productos/revestimientos/13.png',
          img8: 'images/productos/revestimientos/14.png',
        },
               descripcion: "- 100% personalizado <br/><br/>- Durabilidad inmejorable <br/><br/>- Estilo único <br/><br/>- Seguridad garantizada <br/><br/>"
      }}
  ...
  },
  {
    ...
    img1: 'images/productos/chapas/1.jpeg',
    img2: 'images/productos/chapas/2.jpeg',
    img3: 'images/productos/chapas/3.jpeg',
    img4: 'images/productos/chapas/4.jpeg',
    img5: 'images/productos/chapas/5.jpeg',
    img6: 'images/productos/chapas/6.jpeg',
    modelos: {
      "modelo-1": {
        nombre: "Nuestras obras",
        nombre2: "Diseño 100%<br />adaptado a tus<br />espacios",
        imagenes: {
          img1: 'images/productos/chapas/7.jpeg',
          img2: 'images/productos/chapas/8.jpeg',
          img3: 'images/productos/chapas/9.jpeg',
          img4: 'images/productos/chapas/10.jpeg',
          img5: 'images/productos/chapas/11.jpeg',
          img6: 'images/productos/chapas/12.jpeg',
          img7: 'images/productos/chapas/13.jpeg',
          img8: 'images/productos/chapas/14.jpeg',
          img9: 'images/productos/chapas/15.jpeg',
          img10: 'images/productos/chapas/16.jpeg',
          img11: 'images/productos/chapas/17.jpeg',
          img12: 'images/productos/chapas/18.jpeg',
        },
               descripcion: "- 100% personalizado <br/><br/>- Durabilidad inmejorable <br/><br/>- Estilo único <br/><br/>- Seguridad garantizada <br/><br/>"
      }}
  },
  {
    id: 7,
    imagen: 'images/productos/7.png',
    titulo: 'Zócalos en acero inoxidable',
    subtitulo: "Los zócalos de acero inoxidable aportan un detalle único a tus espacios al mismo tiempo que ofrecen estilo, resistencia y durabilidad.",
    descripcion: 'Los zócalos de acero inoxidable aportan un detalle único a tus espacios al mismo tiempo que ofrecen estilo, resistencia y durabilidad.<br/>Contamos con dos presentaciones: rectangulares y borde sanitario.<br/>Los rectangulares, de acero inoxidable 430 y 304 pulido esmerilado, son la opción perfecta para oficinas, casas, empresas y locales que buscan dar un rasgo distintivo y diferente a sus espacios.<br/>Los de borde sanitario están confeccionados en acero inoxidable 304 y 316, pulido esmerilado. Esta opción es ideal para sanatorios, hospitales, laboratorios y farmacias que requieren una resistencia especial a todo tipo de químicos utilizados tanto en pisos como mesadas de trabajo. Un beneficio extra: Ambos son muy fáciles de limpiar y mantener.',
    slug: 'zócalos-en-acero-inoxidable',
  ...
  {
    id: 8,
    imagen: 'images/productos/8.png',
    titulo: 'Rejillas de desagüe pluvial',
    subtitulo: "Ideales para el drenaje de jardines, piletas, patios y galerías dándole un estilo único a sus espacios exteriores.",
    descripcion: 'Ideales para el drenaje de jardines, piletas, patios y galerías dándole un estilo único a sus espacios exteriores.<br/>Cuentan con un marco y una rejilla de acero inoxidable 304, pulido esmerilado, en diferentes medidas. Este material asegura calidad y durabilidad de por vida. Apto tránsito vehicular.',
    slug: 'rejillas-de-desagüe-pluvial',
  ...
  },
  {
    ...
    img5: 'images/productos/rejillas-ventilacion/1.jpg',
